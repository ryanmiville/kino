...
pub fn producer_to_consumer_default_demand_test() {
  ...
  |> subscribe.min_demand(500)
  |> subscribe.max_demand(1000)
  |> subscribe.to(prod)
...
pub fn producer_to_consumer_80_percent_min_demand_test() {
  ...
  subscribe.consumer(consumer)
  |> subscribe.min_demand(80)
  |> subscribe.max_demand(100)
  |> subscribe.to(prod)
...
pub fn producer_to_consumer_0_min_1_max_demand_test() {
  ...
  subscribe.consumer(consumer)
  |> subscribe.min_demand(0)
  |> subscribe.max_demand(1)
  |> subscribe.to(prod)
...
pub fn producer_to_producer_consumer_to_consumer_80_percent_min_demand_test() {
  ...
  producer_consumer.as_consumer(doubler)
  |> subscribe.consumer
  |> subscribe.min_demand(80)
  |> subscribe.max_demand(100)
  |> subscribe.to(prod)
  ...
  subscribe.consumer(consumer)
  |> subscribe.min_demand(50)
  |> subscribe.max_demand(100)
  |> subscribe.through(doubler)
...
pub fn producer_to_producer_consumer_to_consumer_stops_asking_when_consumer_stops_asking_test() {
  ...
  subscribe.consumer(sleeper)
  |> subscribe.min_demand(5)
  |> subscribe.max_demand(10)
  |> subscribe.through(pass_through)
  |> subscribe.min_demand(8)
  |> subscribe.max_demand(10)
  |> subscribe.to(prod)
...
pub fn producer_to_producer_consumer_to_consumer_keeps_emitting_even_when_discarded_test() {
  ...
  subscribe.consumer(forwarder)
  |> subscribe.min_demand(50)
  |> subscribe.max_demand(100)
  |> subscribe.through(discarder)
  |> subscribe.min_demand(80)
  |> subscribe.max_demand(100)
  |> subscribe.to(prod)
